  ...
  return (
    <div className="App">
      <div className='container'>
        ...
        <div className='text'>
          <h2>Encontre <span className='cor'>Beatriz</span> no local de partida</h2>
        ...
        <div className='mensagem'>
          <input type='text' className='area' placeholder='Enviar mensagem para Kauê...'></input>
        ...
        <div className='coments'>
          ...
          <div className='text3'>
            <p>Kauê eu ja estou no local já lhe esperando. estou com camisa azul e calça jeans</p>
          </div>
        ...
        <div className='coments2'>
          ...
          <img className='image' src="https://github.com/kaueronald.png" />
          <div className='text3'>
